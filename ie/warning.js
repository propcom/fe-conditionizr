// FONT
WebFontConfig = {
	google: {families: ['Open+Sans:400,700:latin','Fjalla+One::latin']}
};
(function() {
	...
	var ieWarning = function(cb) {
		if (document.cookie.indexOf('gs_cookie=firstme') == -1) {
			...
			(function() {
				...
				_html.l.style.filter = "alpha(opacity=75)";
				_html.l.style.background = "#272725";
			})();
			...
			(function() {
				...
				_html.d.style.background = "#fff4f4";
				_html.d.style.border = "1px solid #040404";
				_html.d.style.fontFamily = "'Open Sans', sans-serif";
			...
			(function() {
				...
				_html.h.style.borderBottom = "4px dotted #000";
				_html.h.style.marginBottom = "20px";
				_html.h.style.paddingBottom = "15px";
				...
				_html.p1.style.fontFamily = "'Open Sans', sans-serif";
